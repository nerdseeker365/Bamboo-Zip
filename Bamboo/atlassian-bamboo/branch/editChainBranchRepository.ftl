[#-- @ftlvariable name="" type="com.atlassian.bamboo.ww2.actions.branch.EditChainBranchRepository" --]
    ...
    [#if currentVcsTypeSelector?has_content]
        ...
        [#if defaultRepositoryTypeDifferent]
            [@ui.messageBox type="warning"]
                [@s.text name="branch.config.repository.override.defaultRepositoryTypeIsDifferent"]
        ...
        [#if needsReset]
            [@ui.messageBox type="warning"]
                [@s.text name="branch.config.repository.unexpected.parent"]
                    [@s.param][@s.url action="resetChainBranchRepository" namespace="/branch/admin/config" planKey=planKey/][/@s.param]
                [/@s.text]
            [/@ui.messageBox]
        [/#if]
            ...
            <div id="repository-selector">
                ...
                [@ui.bambooSection id='repository-configuration']
                    ...
                    [#if repositoryEditable && !defaultRepositoryTypeDifferent && !parentRemoved]
                        [@ui.bambooSection titleKey='branch.config.repository.override' descriptionKey='branch.config.repository.override.description']
                            <div id="overrideToggle" class="aui-toggle">
