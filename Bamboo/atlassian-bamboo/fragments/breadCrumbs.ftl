...
[#macro showProjectIcon decoratedObject]
    ...
    <div class="aui-avatar aui-avatar-large aui-avatar-project">
        <div class="aui-avatar-inner[#if ctx.featureManager.rotpProjectShortcutsEnabled ] project-shortcut-dialog-trigger[/#if]" data-key="${project.key}" data-name="${project.name?html}" data-entity-type="${entityType}">
