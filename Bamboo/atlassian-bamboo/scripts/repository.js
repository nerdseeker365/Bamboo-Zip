    ...
    BAMBOO.REPOSITORY.repositoryConfig = (function () {
        ...
        var defaults = {
                ...
                configFormSuccess = function(data, isUnsaved) {
                    ...
                    var $repositoryItem = $(repositoryItemTemplateString).addClass('active');

                    // Toggle repository lozenge visibility, AJS.template doesn't allow to use conditions
                    $repositoryItem.find('.repository-item-lozenge')
                        // TODO: https://extranet.atlassian.com/jira/browse/BDEV-12678, service should return isCiEnabled property
                        .toggleClass('hidden', repositoryResult.isCiEnabled !== true);
